<template>
  <div v-show="isStep1">
      ...
      <div class="suggestion_container">
        <h3>审批建议：</h3>
        <div style="margin-right:10vw;margin-top:20px;"><el-input v-model="advice1" type="textarea" :rows="3" placeholder="请输入内容" resize="none"></el-input></div>
        ...
        <div>
          <el-row>
            ...
            <el-col :span="10" style="border-left: 1px solid gray;">
              ...
              <div style="margin-left:20px;margin-right:5vw;margin-top:20px;"><el-input v-model="advice2" type="textarea" :rows="13" placeholder="请输入内容" resize="none"></el-input></div>
